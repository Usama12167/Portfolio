  ...
  return (
    <div id="intro" className="mt-4 mb-10 lg:mb-0">
      <div className="flex h-10 items-center justify-between text-xs font-normal text-LightGray py-4 px-2 md:px-4 w-full bg-MidNightBlack">
        ...
        <div className="flex items-center">
          <a
            href="https://www.upwork.com/freelancers/~010e28ec98424bf30c?viewMode=1"
            target="_blank"
            rel="noreferrer"
          >
            Made with ❤️ by <span className="font-bold">Usama</span>
          </a>
        </div>
        <div className="hidden md:flex items-center">
          ...
          <div>usamashahzad535@gmail.com</div>
        </div>
      </div>
    </div>
  );
