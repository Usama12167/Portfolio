...
//     'https://www.fiverr.com/sellers/usamashahzad853',
//   ],
...
//   ],
//   description:
//     'I am Usama Shahzad, Software Engineer with a  solid 2-year journey in building high-performance, cross-platform mobile and web applications. Strong understanding of JavaScript, Redux, React, Next js and React Native framework. You can find my freelance work on Fiverr at https://www.fiverr.com/ahtishamshahzad.',
    ...
    <Container className="mt-16 sm:mt-32">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        <div className="lg:pl-20">
          <div className="max-w-xs px-2.5 lg:max-w-none" data-aos="fade-left">
            <Image
              src={image}
              alt=""
        ...
        <div className="lg:order-first lg:row-span-2" data-aos="fade-right">
          <h1 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-3xl">
            Usama Shahzad - Software Engineer( Javascript | React Native | React
            | NextJs )
          </h1>
        ...
        <div className="lg:pl-20" data-aos="fade-right">
          <ul role="list">
            {/* <SocialLink
              className="mt-4"
            ...
            <SocialLink
              href="https://www.upwork.com/freelancers/~010e28ec98424bf30c?mp_source=share"
              icon={UpWorkIcon}
            ...
            <SocialLink
              href="https://www.fiverr.com/users/usamashahzad853"
              icon={fiverIcon}
              className="mt-4"
            >
              Fiverr
            ...
            <SocialLink
              href="mailto:usamashahzad535@gmail.com.com"
              icon={MailIcon}
              className="mt-4"
            >
              usamashahzad535@gmail.com.com
            </SocialLink>
            <SocialLink
